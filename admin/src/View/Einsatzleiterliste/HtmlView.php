...
namespace AlexanderGropp\Component\BlaulichtMonitor\Administrator\View\Einsatzleiterliste;
...
/**
 * View-Klasse für die EinsatzleiterListe-Übersicht im Backend.
...
class HtmlView extends BaseHtmlView
{
	...
	public $items = [];     // Die Einsatzleiter-Datensätze
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title('Einsatzleiterliste', 'copy article');

		if ($canDo->get('core.create')) {
			ToolbarHelper::addNew('einsatzleiter.add', 'JTOOLBAR_NEW');
		}
		if ($canDo->get('core.edit')) {
			ToolbarHelper::editList('einsatzleiter.edit', 'JTOOLBAR_EDIT');
		}
		if ($canDo->get('core.edit.state')) {
			ToolbarHelper::publish('einsatzleiterliste.publish', 'JTOOLBAR_PUBLISH', true);
			ToolbarHelper::unpublish('einsatzleiterliste.unpublish', 'JTOOLBAR_UNPUBLISH', true);
			ToolbarHelper::archiveList('einsatzleiterliste.archive', 'JTOOLBAR_ARCHIVE');
			ToolbarHelper::checkin('einsatzleiterliste.checkin');
		}
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'einsatzleiterliste.delete', 'JTOOLBAR_DELETE');
		}
