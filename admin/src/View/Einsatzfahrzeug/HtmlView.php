...
namespace AlexanderGropp\Component\BlaulichtMonitor\Administrator\View\Einsatzfahrzeug;
...
/**
 * View-Klasse für die Einzelansicht einer Einsatzart.
 * Stellt das Formular dar und konfiguriert die Toolbar für die Bearbeitung.
 */
class HtmlView extends BaseHtmlView
{
	/** @var \JForm Formularobjekt für die Einsatzart */
	public $form;

	/** @var object State-Objekt mit Statusinformationen */
	public $state;

	/** @var object Einsatzart-Datensatz */
	public $item;

	/**
	 * Anzeige der Einzelansicht (Formular) für eine Einsatzart.
	...
	{
		// Lade Formular, Status und Einsatzart-Daten aus dem Model
	...
	/**
	 * Konfiguriert die Toolbar für die Einsatzart-Bearbeitung.
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(
			Text::_('COM_BLAULICHTMONITOR_FAHRZEUG_TITLE_' . ($isNew ? 'ADD' : 'EDIT'))
		);

		// Zeige die Buttons zum Speichern und Anwenden, falls Berechtigung vorhanden
		if ($canDo->get('core.create')) {
			$toolbar->apply('einsatzfahrzeug.apply');
			$toolbar->save('einsatzfahrzeug.save');
		}

		// Button zum Abbrechen/Schließen der Bearbeitung
		$toolbar->cancel('einsatzfahrzeug.cancel', 'JTOOLBAR_CLOSE');
	}
}
