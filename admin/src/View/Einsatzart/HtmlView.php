...
namespace AlexanderGropp\Component\BlaulichtMonitor\Administrator\View\Einsatzart;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(
			Text::_('COM_BLAULICHTMONITOR_EINSATZART_TITLE_' . ($isNew ? 'ADD' : 'EDIT'))
		);

		// Zeige die Buttons zum Speichern und Anwenden, falls Berechtigung vorhanden
		if ($canDo->get('core.create')) {
			$toolbar->apply('einsatzart.apply');
			$toolbar->save('einsatzart.save');
		}

		// Button zum Abbrechen/Schließen der Bearbeitung
		$toolbar->cancel('einsatzart.cancel', 'JTOOLBAR_CLOSE');
	}
}
