...
namespace AlexanderGropp\Component\BlaulichtMonitor\Administrator\View\Einsatzkategorie;
...
/**
 * View-Klasse für die Einzelansicht einer Einsatzkategorie.
 * Stellt das Formular dar und konfiguriert die Toolbar für die Bearbeitung.
 */
class HtmlView extends BaseHtmlView
{
	/** @var \JForm Formularobjekt für die Einsatzkategorie */
	public $form;

	/** @var object State-Objekt mit Statusinformationen */
	public $state;

	/** @var object Einsatzkategorie-Datensatz */
	public $item;

	/**
	 * Anzeige der Einzelansicht (Formular) für eine Einsatzkategorie.
	...
	{
		// Lade Formular, Status und Einsatzkategorie-Daten aus dem Model
	...
	/**
	 * Konfiguriert die Toolbar für die Einsatzkategorie-Bearbeitung.
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(
			Text::_('COM_BLAULICHTMONITOR_EINSATZKATEGORIE_TITLE_' . ($isNew ? 'ADD' : 'EDIT'))
		);

		// Zeige die Buttons zum Speichern und Anwenden, falls Berechtigung vorhanden
		if ($canDo->get('core.create')) {
			$toolbar->apply('einsatzkategorie.apply');
			$toolbar->save('einsatzkategorie.save');
		}

		// Button zum Abbrechen/Schließen der Bearbeitung
		$toolbar->cancel('einsatzkategorie.cancel', 'JTOOLBAR_CLOSE');
	}
}
