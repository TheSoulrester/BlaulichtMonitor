...
namespace AlexanderGropp\Component\BlaulichtMonitor\Administrator\View\Einsatzleiter;
...
/**
 * View-Klasse für die Einzelansicht einer Einsatzleiter.
 * Stellt das Formular dar und konfiguriert die Toolbar für die Bearbeitung.
 */
class HtmlView extends BaseHtmlView
{
	/** @var \JForm Formularobjekt für die Einsatzleiter */
	public $form;

	/** @var object State-Objekt mit Statusinformationen */
	public $state;

	/** @var object Einsatzleiter-Datensatz */
	public $item;

	/**
	 * Anzeige der Einzelansicht (Formular) für eine Einsatzleiter.
	...
	{
		// Lade Formular, Status und Einsatzleiter-Daten aus dem Model
	...
	/**
	 * Konfiguriert die Toolbar für die Einsatzleiter-Bearbeitung.
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(
			Text::_('COM_BLAULICHTMONITOR_EINSATZLEITER_TITLE_' . ($isNew ? 'ADD' : 'EDIT'))
		);

		// Zeige die Buttons zum Speichern und Anwenden, falls Berechtigung vorhanden
		if ($canDo->get('core.create')) {
			$toolbar->apply('einsatzleiter.apply');
			$toolbar->save('einsatzleiter.save');
		}

		// Button zum Abbrechen/Schließen der Bearbeitung
		$toolbar->cancel('einsatzleiter.cancel', 'JTOOLBAR_CLOSE');
	}
}
