...
namespace AlexanderGropp\Component\BlaulichtMonitor\Administrator\View\Einsatzarten;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title('Einsatzarten', 'copy article');
		...
		if ($canDo->get('core.edit.state')) {
			ToolbarHelper::publish('einsatzarten.publish', 'JTOOLBAR_PUBLISH', true);
			ToolbarHelper::unpublish('einsatzarten.unpublish', 'JTOOLBAR_UNPUBLISH', true);
			ToolbarHelper::archiveList('einsatzarten.archive', 'JTOOLBAR_ARCHIVE');
			ToolbarHelper::checkin('einsatzarten.checkin');
		}
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'einsatzarten.delete', 'JTOOLBAR_DELETE');
		}
