...
/**
 * Model für die Alarmierungsarten-Übersicht im Backend.
...
class AlarmierungsartenModel extends ListModel
{
	...
	/**
	 * Baut die SQL-Abfrage für die Alarmierungsarten-Liste.
	...
	protected function getListQuery()
	{
		...
		)->from($db->quoteName('#__blaulichtmonitor_alarmierungsarten', 'a'))
			// Join für created_by
	...
	public function getFilterForm($data = [], $loadData = true)
	{
		return $this->loadForm(
			'com_blaulichtmonitor.alarmierungsarten',
			'filter_alarmierungsarten',
