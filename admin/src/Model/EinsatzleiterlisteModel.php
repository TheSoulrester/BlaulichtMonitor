...
/**
 * Model für die Einsatzleiter-Übersicht im Backend.
 ...
 */
class EinsatzleiterlisteModel extends ListModel
{
	...
	/**
	 * Baut die SQL-Abfrage für die Einsatzleiter-Liste.
	...
	protected function getListQuery()
	{
		...
		)->from($db->quoteName('#__blaulichtmonitor_einsatzleiter', 'a'))
			// Join für created_by
	...
	/**
	 * Lädt das Filterformular (siehe filter_einsatzleiter.xml).
