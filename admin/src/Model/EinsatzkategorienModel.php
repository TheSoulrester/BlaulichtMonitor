...
/**
 * Model für die Einsatzkategorien-Übersicht im Backend.
 ...
 */
class EinsatzkategorienModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		)->from($db->quoteName('#__blaulichtmonitor_einsatzkategorien', 'a'))
			// Join für created_by
	...
	public function getFilterForm($data = [], $loadData = true)
	{
		return $this->loadForm(
			'com_blaulichtmonitor.einsatzkategorien',
			'filter_einsatzkategorien',
