...
/**
 * Table-Klasse für Einsatzleiter.
 * Diese Klasse kapselt die Datenbankoperationen für die Einsatzleiter-Tabelle
 * und sorgt für die korrekte Vorverarbeitung und Speicherung der Daten.
 */
class EinsatzleiterTable extends Table
{
	/**
	...
	public function __construct(DatabaseDriver $db)
	{
		...
		parent::__construct('#__blaulichtmonitor_einsatzleiter', 'id', $db);
	}
	...
	{
		// Keine speziellen Felder für Einsatzleiter nötig, aber Platz für spätere Anpassungen
