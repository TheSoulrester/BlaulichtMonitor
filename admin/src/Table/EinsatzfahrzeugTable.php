...
/**
 * Table-Klasse für Einsatzarten.
 * Diese Klasse kapselt die Datenbankoperationen für die Einsatzarten-Tabelle
 * und sorgt für die korrekte Vorverarbeitung und Speicherung der Daten.
 */
class EinsatzfahrzeugTable extends Table
{
	/**
	...
	public function __construct(DatabaseDriver $db)
	{
		...
		parent::__construct('#__blaulichtmonitor_fahrzeuge', 'id', $db);
	}
