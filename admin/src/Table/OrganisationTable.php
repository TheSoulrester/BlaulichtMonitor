...
/**
 * Table-Klasse für Organisationen.
 * Diese Klasse kapselt die Datenbankoperationen für die Organisationen-Tabelle
...
class OrganisationTable extends Table
{
	...
	public function __construct(DatabaseDriver $db)
	{
		...
		parent::__construct('#__blaulichtmonitor_organisationen', 'id', $db);
	}
