...
/**
 * Table-Klasse für Einsatzkategorie.
 * Diese Klasse kapselt die Datenbankoperationen für die Einsatzkategorie-Tabelle
 * und sorgt für die korrekte Vorverarbeitung und Speicherung der Daten.
 */
class EinsatzkategorieTable extends Table
{
	/**
	...
	public function __construct(DatabaseDriver $db)
	{
		...
		parent::__construct('#__blaulichtmonitor_einsatzkategorien', 'id', $db);
	}
	...
	{
		// Keine speziellen Felder für Einsatzkategorie nötig, aber Platz für spätere Anpassungen
