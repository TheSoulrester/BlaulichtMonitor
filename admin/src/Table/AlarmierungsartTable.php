...
/**
 * Table-Klasse für Alarmierungsarten.
 * Diese Klasse kapselt die Datenbankoperationen für die Alarmierungsarten-Tabelle
 * und sorgt für die korrekte Vorverarbeitung und Speicherung der Daten.
 */
class AlarmierungsartTable extends Table
{
	/**
	...
	public function __construct(DatabaseDriver $db)
	{
		...
		parent::__construct('#__blaulichtmonitor_alarmierungsarten', 'id', $db);
	}
	...
	{
		// Keine speziellen Felder für Alarmierungsarten nötig, aber Platz für spätere Anpassungen
