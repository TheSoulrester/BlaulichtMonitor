...
class AlarmierungsartenController extends AdminController
{
	/**
	 ...
	 */
	public function getModel($name = 'Alarmierungsart', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
