...
class EinheitenController extends AdminController
{
	/**
	 ...
	 * @var string
	 */
	protected $text_prefix = 'COM_BLAULICHTMONITOR_EINHEITEN';
	 ...
	 */
	public function getModel($name = 'Einheit', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
