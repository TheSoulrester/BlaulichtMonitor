...
class EinsatzleiterlisteController extends AdminController
{
	/**
	 ...
	 * @var string
	 */
	protected $text_prefix = 'COM_BLAULICHTMONITOR_EINSATZLEITERLISTE';
	 ...
	 */
	public function getModel($name = 'Einsatzleiter', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
    ...
    public function featured()
    {
        ...
        // z.B. um Alarmierungsarten als "besonders" zu markieren.
    }
    */
