...
if ($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_blaulichtmonitor&task=einsatzkategorien.saveOrderAjax&tmpl=component';
	HTMLHelper::_('draggablelist.draggable', 'einsatzkategorienList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
?>

<form action="<?php echo Route::_('index.php?option=com_blaulichtmonitor&view=einsatzkategorien'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
			<div id="j-main-container" class="j-main-container">
				<!-- Such- und Filterformular für die einsatzkategorien-Liste -->
				<?php echo LayoutHelper::render('joomla.searchtools.default', ['view' => $this]); ?>

				<!-- Überschrift für Screenreader, im UI ausgeblendet -->
				<h1 hidden class="page-title">Einsatzkategorien</h1>

				<?php if (empty($this->items)) : ?>
					<!-- Hinweis, falls keine Einsatzkategorien gefunden wurden -->
				...
				<?php else : ?>
					<!-- Tabelle mit allen Einsatzkategorien -->
					<div class="table-responsive">
						<table class="table table-striped itemList" id="einsatzkategorienList">
							...
							<tbody>
								<?php foreach ($this->items as $i => $item) : ?>
									...
									<tr>
										...
										<td>
											<a href="<?php echo Route::_('/administrator/index.php?option=com_blaulichtmonitor&task=einsatzkategorie.edit&id=' . $item->id); ?>">
												<?php echo $item->title; ?>
											</a>
										</td>
