...
/**
 * Template für die Organisationen-Übersicht im Backend.
...
if ($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_blaulichtmonitor&task=organisationen.saveOrderAjax&tmpl=component';
	HTMLHelper::_('draggablelist.draggable', 'organisationenList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
?>

<form action="<?php echo Route::_('index.php?option=com_blaulichtmonitor&view=organisationen'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
			<div id="j-main-container" class="j-main-container">
				<!-- Such- und Filterformular für die Organisationen-Liste -->
				<?php echo LayoutHelper::render('joomla.searchtools.default', ['view' => $this]); ?>

				<!-- Überschrift für Screenreader, im UI ausgeblendet -->
				<h1 hidden class="page-title">Organisationen</h1>

				<?php if (empty($this->items)) : ?>
					<!-- Hinweis, falls keine Organisationen gefunden wurden -->
				...
				<?php else : ?>
					...
					<div class="table-responsive">
						<table class="table table-striped itemList" id="organisationenList">
							<caption class="visually-hidden">
								BlaulichtMonitor Organisationen
							...
							<thead>
								<tr>
									...
									<th scope="col" class="">
										<?php echo HTMLHelper::_('searchtools.sort', 'Name', 'a.title', $listDirn, $listOrder); ?>
									</th>
									<!-- Erstellungsdatum -->
							...
							<tbody>
								<?php foreach ($this->items as $i => $item) : ?>
									...
									<tr>
										...
										<!-- Checkbox für die Auswahl einzelner Zeilen -->
										...
										<td>
											<a href="<?php echo Route::_('/administrator/index.php?option=com_blaulichtmonitor&task=organisation.edit&id=' . $item->id); ?>">
												<?php echo $item->title; ?>
											</a>
										</td>
