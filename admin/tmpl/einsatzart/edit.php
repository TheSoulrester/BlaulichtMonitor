...
<form action="<?php echo Route::_('index.php?option=com_blaulichtmonitor&view=einsatzart&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="einsatzart-form" class="form-validate">
	<div class="container">
		<div class="card mb-4">
			<div class="card-header fw-bold">Einsatzart</div>
			<div class="card-body">
				<div class="row">
					<?php
